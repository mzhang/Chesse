...
Golem::Golem(unique_ptr<Moveable> component, int maxMoves)
    : Decorator{std::move(component)}, maxMoves{maxMoves}, isBroken{false} {}

Golem::Golem(const Golem &o)
    : Decorator{o}, maxMoves{o.maxMoves}, isBroken{o.isBroken} {}

vector<Move> Golem::getValidMoves(const GameState &g,
...
unique_ptr<Moveable> Golem::clone() const { return make_unique<Golem>(*this); }
