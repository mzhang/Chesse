...
Visualizer::Visualizer(const GameState &state, int boardWidth, int boardHeight)
...
void Visualizer::draw_position(const GameState &b, const Position &position) {
  ...
  if (pieceType != PieceType::NONE) {
    ...
    ChessDrawing::draw_chesspiece(*screen, position.x, position.y, pieceType,
                                  owner);
  }
}
...
void Visualizer::doDisplayValidMoves(const GameState &g,
